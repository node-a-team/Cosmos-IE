...
func setConfig(chain string) {
	...
	case "rizon":
		config.SetBech32PrefixForAccount(rizon.Bech32PrefixAccAddr, rizon.Bech32PrefixAccPub)
		config.SetBech32PrefixForValidator(rizon.Bech32PrefixValAddr, rizon.Bech32PrefixValPub)
		config.SetBech32PrefixForConsensusNode(rizon.Bech32PrefixConsAddr, rizon.Bech32PrefixConsPub)
